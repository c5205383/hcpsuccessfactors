		...
		createDetailView: function(){
          ...
          $.ajax({  
             ...
             headerToolbar: new sap.m.Toolbar({
				content: [new sap.m.Title({text:"Test OData Service from https://companylistdemo.hana.ondemand.com/refapp-companylist-web/companylist.svc/"})
						]
			 }),
             columns: [
             new sap.m.Column({
