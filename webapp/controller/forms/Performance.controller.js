...
sap.ui.define([
	...
	"use strict";
	return BaseController.extend("hcpsuccessfactors.controller.forms.Performance", {
		...
		handleResponsivePopoverPress: function(oEvent) {
			if (!this._oPopover) {
				this._oPopover = sap.ui.xmlfragment("hcpsuccessfactors.view.forms.Popover", this);
